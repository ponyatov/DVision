...
#define TVCONFIG_RHIDE_STDINC "$(DJDIR)/include $(DJDIR)/lang/cxx $(DJDIR)/lib/gcc-lib"
#define TVCONFIG_TVSRC "../../include e:/dj/contrib/tvision/include e:/dj/include/rhtvision"
#define TVCONFIG_RHIDE_OS_LIBS "stdcxx tvfintl"
#define TVCONFIG_TVOBJ "../../makes e:/dj/contrib/tvision/makes e:/dj/lib  ../../intl/dummy"
#define TVCONFIG_STDCPP_LIB "-lstdcxx"
#define TVCONFIG_SHARED_CODE_OPTION "-fPIC"
#define TVCONFIG_RHIDE_LDFLAGS "-shared -Wl,-soname,librhtv.so.2.0.2 -lncurses -lstdcxx -lm -lc"
...
#define TVCONFIG_REF_DIR  "e:/dj/contrib/tvision"
