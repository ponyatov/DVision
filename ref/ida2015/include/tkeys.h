...
// Extended key codes
    ...
    kbCtrlPgUp  = 0x8400,   kbF11       = 0x8500,   kbF12       = 0x8600,
    kbShiftF11  = 0x8700,   kbShiftF12  = 0x8800,   kbCtrlF11   = 0x8900,
    kbCtrlF12   = 0x8a00,   kbAltF11    = 0x8b00,   kbAltF12    = 0x8c00,
    kbAltBack   = 0x0800,
    kbNoKey     = 0x0000,
    kbMouse     = 0xFFF0, // internal for xterm

// 101-key keyboard extensions supported by BIOS (24.10.01)
    ...
    kbAltUp          = 0x9800,
    kbAltDown        = 0xa000,
    kbAltOpenBraket  = 0x1a00,
    kbAltCloseBraket = 0x1b00,
    kbAltSemicolon   = 0x2700,
    kbAltApostrophe  = 0x2800,
    kbAltBackApst    = 0x2900,
    kbAltBackslash   = 0x2b00,
    kbAltComma       = 0x3300,
    kbAltDot         = 0x3400,
    kbAltSlash       = 0x3500,
    kbAltDel         = 0xa300,
...
#define MacroStop       kbAltEqual

struct macro_handler_t
{
  ushort (*MacroGetNextKey)(void);
  void (*StartRecording)(void);
  void (*StopRecording)(void);
  void (*SaveMacroKey)(ushort key);
  macro_t *(*FindMacro)(ushort key);
  bool (*StartPlayingMacro)(const macro_t *ptr);
  bool (*MacroPlaying)(void);
};

extern macro_handler_t macro_handler;
