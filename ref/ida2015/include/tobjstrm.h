...
public:
    ...
    NORETURN void _Cdecl error( StreamableError );
    NORETURN void _Cdecl error( StreamableError, const TStreamable& );
...
public:
    ...
    ipstream& _Cdecl seekg( streamoff, ios::seekdir );
...
public:
    ...
    opstream& _Cdecl seekp( streamoff, ios::seekdir );
...
public:
    ...
    _Cdecl fpbase();
    _Cdecl fpbase( const char *, int, int = 0 );
    _Cdecl fpbase( int );
    _Cdecl fpbase( int, char *, int );
    _Cdecl ~fpbase();

    void _Cdecl open( const char *, int, int = 0 );
...
public:
    ...
    _Cdecl fpstream();
    _Cdecl fpstream( const char *, int, int = 0 );
    _Cdecl fpstream( int );
