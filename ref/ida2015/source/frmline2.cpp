...
void TV_CDECL TFrame::frameLine( TDrawBuffer& frameBuf, short y, short n, uchar color ) const
{
...
//  unsigned char* src=frameMask;
  TCharHolder* dest=frameBuf.data;
  i = ushort(size.x);
  short int i1=0;
  while (i--) {
#ifndef __UTF8__
...
#else
      *dest++= color | frameChars[frameMask[i1]] << 8;
#endif
    i1++;
  } /* endwhile */
}
