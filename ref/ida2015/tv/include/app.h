...
public:
     ...
     */
    TBackground( const TRect& bounds, TSymbol aPattern );
    /**
...
public:
     ...
     */
    TDeskInit( TBackground *(*cBackground)( const TRect &bounds ) );
protected:
    /**
     ...
     */
    TBackground *(*createBackground)( const TRect &bounds );
};
...
public:
     ...
     */
    static TBackground *initBackground( const TRect & );
    /**
