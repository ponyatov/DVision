...
//-------------------------------------------------------------------------
ushort scanKeyMap( const void *keyMap, int keyCode ); // see TEDITOR1.CPP
...
public:
     ...
     * Undocumented.
     */
    static TSymbol dragFrame;
    /**
     * Undocumented.
     */
    static TSymbol normalFrame;
protected:
    /**
...
public:
    ...
    TSymbol TV_CDECL bufChar( size_t ) const;
    size_t TV_CDECL bufPtr( size_t ) const;
    virtual void changeBounds( const TRect& );
    virtual void convertEvent( TEvent& );
    Boolean cursorVisible() const;
    void deleteSelect();
    ...
    Boolean insertBuffer( const char *, size_t, size_t, Boolean, Boolean );
    ...
    void setCmdState( ushort, Boolean ) const;
    ...
    int charPos( size_t, size_t ) const;
    size_t charPtr( size_t, int ) const;
    Boolean clipCopy();
    void clipCut();
    void clipPaste();
    ...
    void TV_CDECL formatLine(void *, size_t, int, ushort ) const;
    void find();
    size_t getMousePtr( const TPoint & ) const;
    Boolean hasSelection() const;
    void hideSelect();
    Boolean isClipboard() const;
    size_t TV_CDECL lineEnd( size_t ) const;
    size_t lineMove( size_t, int ) const;
    size_t TV_CDECL lineStart( size_t ) const;
    void lock();
    void newLine();
    size_t TV_CDECL nextChar( size_t ) const;
    size_t nextLine( size_t ) const;
    size_t nextWord( size_t ) const;
    size_t TV_CDECL prevChar( size_t ) const;
    size_t prevLine( size_t ) const;
    size_t prevWord( size_t ) const;
    void replace();
    ...
    void unlock();
    void update( uchar );
    void checkScrollBar( const TEvent&, const TScrollBar *, int& );
...
public:
    ...
    virtual void close();
    virtual const char *getTitle( short ) const;
    virtual void handleEvent( TEvent& );
