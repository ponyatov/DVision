...
public:
    ...
    int getNumCrossRefs() const;
    int numLines();
    void setCrossRef( int i, const TCrossRef& ref );
...
private:
    ...
    char *wrapText( char *text, int size, int& offset, Boolean wrap,
                    char *lineBuf, size_t lineBufLen ) const;
...
public:
    ...
    THelpTopic *getTopic( int ) const;
    THelpTopic *invalidTopic() const;
