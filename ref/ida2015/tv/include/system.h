...
const int meWheelForw   = 0x40;
const int meWheelBackw  = 0x80;
...
public:
     ...
     * of pairs.
     */
    static void writeRow(int dst, TCharHolder *src, int len);
#endif
     ...
     * It is initialized by the constructor of this class.
     */
    static TCharHolder *screenBuffer;
...
#ifdef __UNIX__
    /**
     * Hold the desktop size in pixels
     *
     * It is initialized by the constructor of this class.
     */
...
bool  x11_clipboard_put(const char*, size_t, size_t);
#define MAX_GET_FROM_CLIP	(200*133)  // maximum size for insert in editdialog's
char* x11_clipboard_get(size_t&, bool);
