...
public:
    ...
    NORETURN static void error( ccIndex code, ccIndex info );

    void *firstThat( ccTestFunc Test, void *arg ) const;
    void *lastThat( ccTestFunc Test, void *arg ) const;
    void forEach( ccAppFunc action, void *arg ) const;
